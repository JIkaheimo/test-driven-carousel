...
describe('Carousel', () => {
  ...
  describe('component with HOC', () => {
    ...
    it('allows `slideIndex` to be controller', () => {
  ...
  describe('core component', () => {
    ...
    it('renders a CarouselButton labeled "Prev"', () => {
      expect(wrapper.find('[data-action="prev"]').prop('children')).toBe('Prev');
    });

    it('renders a CarouselButton labeled "Next"', () => {
      expect(wrapper.find('[data-action="next"]').prop('children')).toBe('Next');
    });
